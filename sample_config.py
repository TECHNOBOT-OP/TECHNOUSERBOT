...
class Config(object):
    ...
    TECHNO_STRING = os.environ.get("TECHNO_STRING", None)
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TECHNOBOT-OP/TECHNOUSERBOT"
    )
    ...
    # Custom vars for Technobot
    # set this will channel id of your custom plugins
    PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL") or 0)
    # set this value with your required name for telegraph plugin
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "technouserbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://te.legra.ph/file/d882eee939a66432650b4.jpg"
    )
    # specify NO_LOAD with plugin names for not loading in Technobot
