...
from Technobot import CMD_HELP, LOAD_PLUG
...
def load_module(shortname, plugin_path=None):
    if shortname.startswith("__"):
        ...
        checkplugins(path)
        name = "Technobot.plugins.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["Technobot.plugins." + shortname] = mod
        LOGS.info("TechnoBot " + shortname)
