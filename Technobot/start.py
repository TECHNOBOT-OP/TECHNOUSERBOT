...
from .core.session import techno, tgbot
...
async def killer():
    ...
    description = f"I am Assistant Of {tech_mention}.This Bot Can Help U To Chat With My Master  @TechnoBot_Official"
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_file(
                "@BotFather", "Technobot/helpers/resources/pics/main.jpg"
            )
