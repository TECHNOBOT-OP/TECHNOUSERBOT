...
def main_menu():
    ...
    buttons = [
        ...
        [
            ...
            Button.url("Support 🇮🇳", "https://t.me/TechnoBot_Updates"),
        ],
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**TechnoBot"):
            buttons = [
                ...
                (
                    ...
                    Button.url("Repo", "https://github.com/TECHNOBOT-OP/TECHNOUSERBOT"),
                ),
            ]
        ...
        if query.startswith("**⚜ TechnoBot"):
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚜ Technical Af TechnoBot ⚜**",
                buttons=[
                    [Button.url("♥️ Tutorial ♥", "https://youtu.be/CH_KO1wim2o")],
                    [Button.url("📍 𝚁𝚎𝚙𝚘 📍", "https://github.com/TECHNOBOT-OP/TechnoBot")],
                    [
                        Button.url(
                            "💞 Deploy 💞",
                            "https://heroku.com/deploy?template=https://github.com/TECHNOBOT-OP/TECHNOBOT",
                        )
                    ],
                ],
            )
            ...
            builder = event.builder
            troll = os.path.join("./Technobot", "troll.txt")
            try:
            ...
            user, txct = query.split(" ", 1)
            builder = event.builder
            secret = os.path.join("./Technobot", "secrets.txt")
            try:
            ...
            query = query[5:]
            builder = event.builder
            hide = os.path.join("./Technobot", "hide.txt")
            try:
            ...
            if oso == "OFF":
                result = builder.article(
                    title="© TechnoBot Help",
                    description="Help menu for TechnoBot",
                    text=_result[0],
                    buttons=_result[1],
                    link_preview=False,
                )
            ...
            buttons = [
                (
                    Button.url("Source code", "https://github.com/TECHNOBOT-OP/TECHNOBOT"),
                    Button.url(
                        "Deploy",
                        "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTECHNOBOT-OP%2FTECHNOBOT&template=https%3A%2F%2Fgithub.com%2FTECHNOBOT-OP%2FTECHNOBOT",
                    ),
                )
            ]
            ...
            result = types.InputBotInlineResult(
                ...
                type="photo",
                title=f"†ê¢hñðßð†",
                description=f"†ê¢hñðßð†\nhttps://t.me/TechnoBot_Support",
                url="https://github.com/TECHNOBOT-OP/TECHNOBOT",
                thumb=photo,
                content=photo,
                send_message=types.InputBotInlineMessageMediaAuto(
                    reply_markup=markup, message=text, entities=msg_entities
...
async def on_plug_in_callback_query_handler(event):
    ...
    await event.edit(
        f"📜 Menu Provider Has Been Closed\n\n🔰 Bot Of : {mention}\n\n             [©️†ê¢hñðßð†](https://t.me/TechnoBot_Support)",
        buttons=buttons,
        link_preview=False,
    )
