...
msg = f"""
**⚜ 𝙻𝚎𝚐𝚎𝚗𝚍𝚊𝚛𝚢 𝙰𝚏 𝚃𝚎𝚌𝚑𝚗𝚘𝙱𝚘𝚝 ⚜**
  •        [♥️ 𝚁𝚎𝚙𝚘 ♥️](https://github.com/TECHNOBOT-OP/TECHNOBOT)
  •        [♦️ Deploy ♦️](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTECHNOBOT-OP%2FTECHNOBOT&template=https%3A%2F%2Fgithub.com%2FTECHNOBOT-OP%2FTECHNOBOT)
  •  ©️ {Techno_channel} ™
"""
...
@techno.techno_cmd(
    ...
    info={
        "header": "Source code link of Technobot",
        "usage": [
            "{tr}repo",
        ],
    },
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": ["{tr}github TECHNOBOT-OP", "{tr}github -l5 TECHNOBOT-OP"],
    },
)
async def _(event):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **Technobot/plugins** folder\
...
async def download(event):
    ...
    if Config.GIT_REPO_NAME is None:
        return await eod(
            event, "`Please ADD Proper Github Repo Name of your Technobot`", 5
        )
...
async def git_commit(file_name, mone):
    ...
    if create_file:
        file_name = f"Technobot/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/Technobot/plugins/)"
            )
