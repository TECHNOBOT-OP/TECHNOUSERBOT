...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [TechnoUserBot]<buttonurl:https://t.me/TechnoBot_Support17:same> [support]<buttonurl:https://t.me/TechnoBot_Updates>",
    },
)
async def _(event):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [TechnoBot]<buttonurl:https://t.me/TechnoBot_Updates:same> [support]<buttonurl:https://t.me/TechnoBot_op>",
    },
)
async def _(event):
