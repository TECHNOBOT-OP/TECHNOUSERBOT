...
from . import techno, swtmemes, useless
...
async def _(event):
    "fun animation"
    technoevent = await eor(event, "`kiss`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵💋👰"]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await technoevent.edit(animation_chars[i % 4])
...
async def _(event):
    "fun animation"
    technoevent = await eor(event, "`fuking....`")
    animation_interval = 0.2
    animation_ttl = range(100)
...
async def _(event):
    "fun animation"
    technoevent = await eor(event, "`sex`")
    animation_interval = 0.2
    animation_ttl = range(100)
    animation_chars = ["🤵       👰", "🤵     👰", "🤵  👰", "🤵👼👰"]
    for i in animation_ttl:
