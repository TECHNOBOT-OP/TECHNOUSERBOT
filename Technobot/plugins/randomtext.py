...
async def indslogan(event):
    ...
    if x == 2:
        await event.edit(
            "DON'T TRY TO KNOW ABUOT ME I M TECHNO✌️ @Technoboy_02\nfrom: @TechnoBot_Support"
        )
    if x == 3:
...
async def _(event):
    ...
    if x == 25:
        await event.edit("Written and Created By: @Technoboy_02 ! thank you🙏🏻❤")
