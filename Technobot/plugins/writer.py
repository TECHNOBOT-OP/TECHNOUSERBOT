...
async def note(e):
    ...
    img = Image.open("Technobot/helpers/resources/extras/template.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("Technobot/helpers/resources/fonts/assfont.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
