...
# TechnoUserBot module for having some fun with people.
import asyncio
import random
import re
...
from ..helpers.utils import _technoutils, parse_pre
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}squirrelsay Technouserbot",
            "{tr}milksay TechnoUserBot",
            "{tr}ghostbustersghostbusterssay Technouserbot",
        ],
    },
)
...
async def gbun(event):
    ...
    technoevent = await eor(event, "**Summoning out le Gungnir ❗️⚜️☠️**")
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1035034432:
            ...
            if len(gbunVar) > 0:
                ...
                jnl += no_reason
            await technoevent.edit(jnl)
    else:
        mention = "`Warning!! User 𝙂𝘽𝘼𝙉𝙉𝙀𝘿 By Admin...\nReason: Potential spammer. `"
        await technoevent.edit(mention)
