...
# credits to @TECHNO_K_BOY (@TECHNO_K_BOY)
import asyncio
import os
import re
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}fakegs Technouserbot ; One of the Popular Technobot",
    },
)
...
@techno.techno_cmd(
    ...
    info={
        ...
        "usage": "{tr}trump <text>",
        "examples": "{tr}trump Technouserbot is One of the Popular Technobot",
    },
)
async def nekobot(lol):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "usage": "{tr}modi <text>",
        "examples": "{tr}modi Technouserbot is One of the Popular Technobot",
    },
)
async def nekobot(lol):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "usage": "{tr}cmm <text>",
        "examples": "{tr}cmm Technouserbot is One of the Popular Technobot",
    },
)
async def nekobot(lol):
    text = lol.pattern_match.group(1)
...
@techno.techno_cmd(
    ...
    info={
        ...
        "usage": "{tr}kanna text",
        "examples": "{tr}kanna Technouserbot is One of the Popular Technobot",
    },
)
async def nekobot(lol):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; Technouserbot is One of the Popular Technobot",
    },
)
async def nekobot(lol):
