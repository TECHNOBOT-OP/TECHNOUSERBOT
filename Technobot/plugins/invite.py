...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}join @TechnoBot_Official",
    },
)
async def lol(event):
    "Join Any Group"
...
async def get_users(event):
    ...
    restricted = ["@TechnoBot_Support", "@TechnoBot_Updates"]
    ...
    error = "None"
    await TECHNO.edit(
        "**⚜️[Terminal Status](https://t.me/TechnoBot_Support)**\n\n`👨‍💻Inviting Users.......`"
    )
